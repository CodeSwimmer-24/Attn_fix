...
const std::string States::Cols::_id = "id";
const std::string States::Cols::_name = "name";
const std::string States::primaryKeyName = "id";
...
const uint32_t &States::getValueOfId() const noexcept
{
...
const std::shared_ptr<uint32_t> &States::getId() const noexcept
{
    return id_;
}
void States::setId(const uint32_t &pId) noexcept
{
...
const std::string &States::getValueOfName() const noexcept
{
...
const std::shared_ptr<std::string> &States::getName() const noexcept
{
    return name_;
}
void States::setName(const std::string &pName) noexcept
{
    name_ = std::make_shared<std::string>(pName);
    dirtyFlag_[1] = true;
}
void States::setName(std::string &&pName) noexcept
{
