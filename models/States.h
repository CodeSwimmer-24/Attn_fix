...
class States
{
  public:
     ...
     */
    explicit States(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<States>;
    friend drogon::orm::BaseBuilder<States, true, true>;
    friend drogon::orm::BaseBuilder<States, true, false>;
    friend drogon::orm::BaseBuilder<States, false, true>;
    friend drogon::orm::BaseBuilder<States, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<States>;
#endif
